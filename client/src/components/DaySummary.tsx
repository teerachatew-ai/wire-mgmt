...
export default function DaySummary({ groups, note, unitLabel = 'รวม' }: { groups: SumGroup[]; note?: string; unitLabel?: string }) {
  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-2 flex-wrap gap-1">
        ...
        <span className="text-sm text-gray-500">{unitLabel}ทั้งหมด <b className="text-gray-800">{fmt(total)}</b></span>
      </div>
