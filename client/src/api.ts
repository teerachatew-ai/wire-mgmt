  ...
  read: async () => {
    try {
      ...
      try {
        ...
        // ทั้งสองทางไม่สำเร็จ -> สาเหตุที่พบบ่อยที่สุดคือยังไม่ได้เปิดตัวช่วยอ่านบัตรในเครื่องนี้ ไม่ใช่ปัญหาไดรเวอร์/ฮาร์ดแวร์
        throw { response: { data: { error: 'ไม่พบตัวช่วยอ่านบัตรในเครื่องนี้ — เปิดโปรแกรม "2-เปิดตัวช่วยอ่านบัตร.bat" ในโฟลเดอร์ card-reader-helper (เครื่องที่เสียบเครื่องอ่านบัตรอยู่) ทิ้งไว้ก่อน แล้วกดลองใหม่' } } };
      }
    }
  },
};
