...
export const reportApi = {
  ...
  payrollDetailExport: (month: string, format?: 'pdf', paperSize?: 'A4' | 'A5') => api.post('/reports/payroll-detail-export', { month, paper_size: paperSize || 'A4' }, { params: format ? { format } : {}, responseType: 'blob', timeout: 90000 }).then(r => r.data),
